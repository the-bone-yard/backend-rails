...
describe 'UserParkSerializer' do
  it 'creates a JSON object with specific attributes' do
    ...
    3.times do
      Park.create!({ name: 'The Park', formatted_address: '1222 Not an Address', opening_hours: 'never',
                     photo: 'no photo for you', rating: 'all of them', email: '222@email.com', lat: '1222.44', lng: '-5506.22', user_id: user.id })
    end
